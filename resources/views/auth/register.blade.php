...
<!-- Mirrored from coderthemes.com/ubold/layouts/default/auth-register-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:26:09 GMT -->
<head>
        <meta charset="utf-8" />
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="p-3">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Already have account? <a href="auth-login-2.html" class="text-muted ms-1"><b>Log In</b></a></p>
                        </footer>
